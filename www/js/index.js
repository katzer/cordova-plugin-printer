...
var app = {
    ...
    print: function () {
        ...
        cordova.plugins.printer.print(page, options, function (result) {
            alert(result);
        });
    }
};
